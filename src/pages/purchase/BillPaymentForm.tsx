...
export default function BillPaymentForm() {
  ...
  useEffect(() => {
    if (preselectedBillId) reset(prev => ({ ...prev, billId: preselectedBillId }));
  }, [preselectedBillId, reset]);
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold mb-2">Record Bill Payment</h1>
      <p className="text-muted-foreground mb-6">Amount, mode, date, and reference.</p>
      <form onSubmit={handleSubmit(onSubmit)}>
        <Card>
          ...
          <CardFooter className="flex gap-2">
            ...
            <Button type="button" variant="outline" asChild><Link to="/purchase/payments">Cancel</Link></Button>
          </CardFooter>
        </Card>
      </form>
    </div>
